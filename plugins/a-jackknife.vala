...
class AXIOME.Analyses.JackKnife : RuleProcessor {
	...
	public override bool process(Xml.Node *definition, Output output) {
		...
		if (pipeline.to_string() == "mothur") {
			definition_error(definition, "Jackknife plugin not available for mothur. Sorry! Skipping...\n");
